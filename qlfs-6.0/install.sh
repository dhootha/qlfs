...
# Dovremmo controllare se il kernel 
# dell'host e' minimo un 2.6.2 compilato
# con gcc-3.0 o superiore.
# Le informazioni si trovano nel file cat /proc/version
...
echo -e "Uso: ./install.sh [OPZIONE] -l={ita | eng}
  ...
  -l={ita |eng | fra}, --language={ita | fra  |eng}  Lancia lo script nella lingua selezionata italiano o inglese.
...
{
echo -e "QLFS install.sh versione: 5.1.1alpha
Scritto da Marco Sciatta e Matteo Mattei.

Collaboratori : Emanuele Rogledi,Daniele Maio e Giovanni Scafora.
Copyleft (C) QLFS ;P
